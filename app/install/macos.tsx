        ...
        <div>
            ...
            <ol className={"list-decimal pl-6 mt-2 space-y-2"}>
                <li>
                    ...
                    <br/><br/>
                    Alternatively, you can find the <CodeLine>pkg</CodeLine> installer on the <Link href="https://github.com/snowfoxsh/aplang/releases" target="_blank"
                    rel="noreferrer"><CodeLine variant={"link"}>Releases</CodeLine></Link> page on the GitHub
                    repository.
